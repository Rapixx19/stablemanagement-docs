...
- Article (service) sync uses Bexio article codes; we maintain a mapping table or push articles ad-hoc.
...
`apps/owner/tests/integration/bexio-push.test.ts`
